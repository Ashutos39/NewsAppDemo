//
//  NewsApiDemoCoreDataWorker+UtilityOperation.swift
//
//  NewsApiDemoDemoApp
//
...
extension NewsApiDemoCoreDataWorker: NewsApiDemoCoreDataWorkerUtilityOperationProtocol {
    ...
    //it doesn't has "coreDataStack.hasStore" condition because it needs a context to work and the context exposed from this NewsApiDemoCoreDataWorker has that condtion, so if this class is exposing new context always check for that "coreDataStack.hasStore" condition
    @discardableResult
